...
namespace Bang.DAL.Migrations
{
    ...
    [Migration("20211114211518_lasttarget")]
    partial class lasttarget
    {
            ...
            modelBuilder.Entity("Bang.DAL.Domain.GameBoard", b =>
                {
                    ...
                    b.HasIndex("TargetedPlayerId")
                        .IsUnique()
                        .HasFilter("[TargetedPlayerId] IS NOT NULL");
            ...
            modelBuilder.Entity("Bang.DAL.Domain.GameBoard", b =>
                {
                    ...
                    b.HasOne("Bang.DAL.Domain.Player", "TargetedPlayer")
                        .WithOne()
                        .HasForeignKey("Bang.DAL.Domain.GameBoard", "TargetedPlayerId")
                        .OnDelete(DeleteBehavior.NoAction);
